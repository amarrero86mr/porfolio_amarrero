...
export const Footer = () => {
    ...
    return (
        <div>
            ...
            <nav className="nav z-20 fixed bottom-0 p-3 h-16 w-full flex flex-row justify-between border-t-2 bg-transparent" 
            id="footer"
